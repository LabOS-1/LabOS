...
# Add parent directory to path (labos-be root)
sys.path.insert(0, str(Path(__file__).parent.parent))

from dotenv import load_dotenv
# Load .env from labos-be root
...
if not DB_USER or not DB_PASSWORD:
    ...
    print("Please set DB_USER and DB_PASSWORD in labos-be/.env file")
    print("\nAdd these lines to .env:")
    print("  DB_USER=your_db_user")
    print("  DB_PASSWORD=your_db_password")
    sys.exit(1)

DB_NAME_DEV = os.getenv('DEV_DB_NAME', 'labos_chat_dev')
DB_NAME_PROD = os.getenv('DB_NAME', 'labos_chat')
