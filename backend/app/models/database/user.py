...
class User(Base):
    ...
    auth0_id = Column(String(255), unique=True, nullable=False, index=True)  # Auth0 sub
    ...
    # Relationships
    projects = relationship("ChatProject", back_populates="user", cascade="all, delete-orphan")
