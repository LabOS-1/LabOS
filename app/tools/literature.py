...
# Cancellation is now handled in the Agent callback (workflow_callback.py)
# This provides unified cancellation checking for all tools without individual wrapping

print("✅ Literature tools loaded - cancellation handled in Agent callback")